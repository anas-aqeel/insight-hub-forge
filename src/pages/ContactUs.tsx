        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-7 flex flex-col gap-8">
                ...
                <CardContent className="p-8">
                  {submitted ? (
                    <div className="flex flex-col items-center justify-center py-8">
                      <div className="w-16 h-16 rounded-full bg-bright-orange/20 flex items-center justify-center mb-4">
                        <CheckCircle size={32} className="text-bright-orange" />
                      </div>
              ...
              <Card className="bg-gradient-to-br from-dark-gray/70 to-dark-gray/30 border-vibrant-pink/30 animate-slide-in-delay-1">
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold mb-6 text-white flex items-center gap-2">
                    <Users size={20} className="text-bright-orange" />
                    Why Connect With Us?
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gradient-to-br from-vibrant-pink/10 to-bright-orange/10 border border-vibrant-pink/20 rounded-lg p-4">
                      <CheckCircle size={20} className="text-bright-orange mb-2" />
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
              <Card className="h-full bg-gradient-to-br from-dark-gray/70 to-dark-gray/30 border-vibrant-pink/30 animate-slide-in-delay-2">
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold mb-6 text-white flex items-center gap-2">
                  ...
                  <div className="mt-8">
                    ...
                    <div className="flex space-x-3">
                      <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full bg-dark-gray/50 border border-vibrant-pink/30 text-bright-orange hover:bg-bright-orange/20 hover:border-bright-orange/50 transition-colors">
                        <Twitter size={18} />
                      </a>
                      <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full bg-dark-gray/50 border border-vibrant-pink/30 text-bright-orange hover:bg-bright-orange/20 hover:border-bright-orange/50 transition-colors">
                        <Linkedin size={18} />
              ...
              <Card className="bg-gradient-to-br from-dark-gray/70 to-dark-gray/30 border-vibrant-pink/30 animate-slide-in-delay-3">
                <CardContent className="p-8">
                  <h3 className="text-xl font-bold mb-4 text-white flex items-center gap-2">
                    <Building size={20} className="text-bright-orange" />
          ...
          <div className="mt-16 animate-slide-in-delay-4">
            <iframe 
              ...
              allowFullScreen 
              loading="lazy"
              className="border border-vibrant-pink/30 rounded-xl"
            ></iframe>
          </div>
        </div>
      </section>
